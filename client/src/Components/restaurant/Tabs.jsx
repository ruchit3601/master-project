...
const Tab = (props) => {
    ...
    return (
        <Link to={`/restaurant/${id}/${props.route}`}>
            <div className={classnames("text-gray-600 relative font-normal", {
...
const TabContainer = (props) => {
    ...
    return (
        <>
            <div className="flex relative items-center pb-4 gap-16 md:overflow-hidden overflow-x-scroll border-b-2">
                {tabs.map((tab) => (
