...
const LargeTabs = () =>{
    const [alltypes , setAllTypes] = useState([
        ...
        {
            id: `nutri`,
            imageDefault: "https://b.zmtcdn.com/data/o2_assets/54cad8274d3c3ec7129e0808a13b27c31616582882.png?output-format=webp",
        ...
        <>
            <div className="hidden lg:flex gap-14 container px-20 mx-auto">
                ...
                >
                     ...
                     <h3 className={type === items.id ? "text-xl text-zomato-400" : "text-gray-700 "}>{items.name}</h3>
                 </div>
                 </Link>
                ))}
            </div>
